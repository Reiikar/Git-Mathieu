...
We start by discussing the third step, which is the easiest to formalize. 
 ...
 The second is to solve a linear system as in section~\ref{section6.1}. In order to build it, we start by recalling that there exists (from Proposition~\ref{dual}) a divisor $G' \in  \Div(\X)$ such that 
